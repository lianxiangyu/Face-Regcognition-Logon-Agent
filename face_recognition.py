...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        pnet, rnet, onet = detect_face.create_mtcnn(sess, './facenet-master/src/align')
        ...
        HumanNames = ["William Lian"]  # train human name

        print('Loading feature extraction model')
        modeldir = './Pre-trained_Model/20170511-185253.pb'
